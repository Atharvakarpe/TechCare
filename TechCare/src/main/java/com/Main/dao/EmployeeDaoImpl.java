...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public List<Employee> getAllEmployees() {
        ...
        try (Connection conn = DBUtil.provideConnection()) {
            String sql = "SELECT empID, name, email, status FROM employee"; // Adjust the table and columns as per your database
            ...
            while (rs.next()) {
                ...
                Employee employee = new Employee(empID, name, email, status);
